...
const PARTIAL_COVERAGE: Record<string, ExchangeId[]> = {
  ...
  COPPER:    ['HL', 'BINANCE', 'BITGET', 'OKX', 'GATE', 'MEXC', 'KUCOIN', 'PHEMEX', 'HTX', 'WEEX', 'BITMART'],   // W2 C1 Gate XCU + C2 MEXC + C3 KuCoin literal; W3A C1 Phemex COPPER direct; W3A C3 HTX COPPER direct
  ...
  PALLADIUM: ['HL', 'BINANCE', 'BITGET', 'OKX', 'GATE', 'MEXC', 'KUCOIN', 'PHEMEX', 'HTX', 'WEEX', 'BITMART'],   // W2 Gate/MEXC/KuCoin XPD + W3A C1 Phemex XPD; W3A C3 HTX XPD
  PLATINUM:  ['HL', 'BINANCE', 'BITGET', 'OKX', 'GATE', 'MEXC', 'KUCOIN', 'PHEMEX', 'HTX', 'WEEX', 'BITMART'],   // W2 Gate/MEXC/KuCoin XPT + W3A C1 Phemex XPT; W3A C3 HTX XPT
  ...
  VIX:       ['HL', 'GATE', 'PHEMEX', 'BITMART'],                      // W2 C1: Gate VIX_USDT; W3A C1: Phemex VIXUSDT direct
  ...
  GOLD:      ['HL', 'BINANCE', 'BYBIT', 'OKX', 'BITGET', 'GATE', 'MEXC', 'KUCOIN', 'PHEMEX', 'BINGX', 'HTX', 'BITMART'],     // W2 Gate XAU + MEXC XAUT + KuCoin XAUT; W3A C1 Phemex XAU; W3A C2 BingX XAUT; W3A C3 HTX XAU
  SILVER:    ['HL', 'BINANCE', 'BYBIT', 'OKX', 'BITGET', 'GATE', 'MEXC', 'KUCOIN', 'PHEMEX', 'HTX', 'WEEX', 'BITMART'],     // W2 Gate XAG + MEXC literal + KuCoin XAG; W3A C1 Phemex XAG; W3A C3 HTX XAG
  ...
  MSFT:      ['HL', 'BINANCE', 'BYBIT', 'OKX', 'BITGET', 'GATE', 'KUCOIN', 'PHEMEX', 'HTX', 'WEEX', 'BITMART'],   // W3A C1 Phemex MSFTUSDT direct; W3A C3 HTX MSFT-USDT direct
  ...
  USOIL:     ['HL', 'PHEMEX', 'HTX', 'WEEX', 'BITMART'],   // Phemex CLOUSDT (alias from USOIL via TRADFI_ALIASES); HTX USOIL-USDT direct
};
 ...
 */
export const COVERAGE_PROBED_AT = '2026-05-20';   // PILOT-ADAPTERS-W3B / C2 (2026-05-20) — Bitmart added to 9 TradFi rows (GOLD/SILVER/PLATINUM/PALLADIUM/COPPER/CL/USOIL/MSFT/VIX). Bitmart has BOTH XAU + XAUT — adapter prefers XAU spot. SPX intentionally NOT aliased (memecoin trap; SPXUSDT=$0.37 verified).

...
<script type="application/ld+json" data-algovault-jsonld="Product">
{
  ...
  "@type": "Product",
  "name": "AlgoVault",
  "description": "Composite BUY/SELL/HOLD trade calls for AI trading agents. 14 crypto perp venues. Market regime classification and cross-venue funding-rate arbitrage. Every signal Merkle-anchored on Base L2.",
...
<script type="application/ld+json" data-algovault-jsonld="Service">
{
  ...
  "url": "https://algovault.com",
  "description": "Composite BUY/SELL/HOLD trade calls with confidence, market regime classification, and cross-venue funding-rate arbitrage. 14 crypto perp venues. Every signal Merkle-anchored on Base L2 and verifiable at /verify.",
...
<script type="application/ld+json" data-algovault-jsonld="SoftwareApplication">
{
  ...
  "description": "Composite trade calls for AI trading agents. 14 crypto perp venues, 730+ assets, 11 timeframes. Market regime classification + cross-venue funding-rate arbitrage. Every signal Merkle-anchored on Base L2.",
  "url": "https://algovault.com",
  "offers": [
...
<meta name="description" content="AlgoVault is a self-tuning quant ML model served as an MCP API. One call returns a composite verdict — direction, confidence, regime — across 14 perp venues. Every call Merkle-anchored on Base L2.">

 ...
 *
 * Measured dying at N=5 concurrent gates: `runHealthProbeSweep completes and expires ...` took
 * 5,074 ms against the 5,000 ms default. It awaits timers rather than spawning, so starvation
 * stretches it the same way a spawn is stretched.
 *

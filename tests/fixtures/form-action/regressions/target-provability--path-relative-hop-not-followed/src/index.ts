...
app.post('/checkout', express.urlencoded({ extended: false }), (req, res) => { res.redirect(303, '?confirm=1'); });
...
app.post('/billing/start', (req, res) => { res.redirect(303, 'pay'); });
app.post('/billing/start2', (req, res) => { res.redirect(303, './pay'); });
app.get('/billing/pay', async (req, res) => { res.redirect(303, await mintCheckout()); });
app.post('/billing/start3', (req, res) => { res.redirect(303, '../billing/pay'); });
app.post('/billing/start4', (req, res) => { res.redirect(303, '/billing/start/../pay'); });

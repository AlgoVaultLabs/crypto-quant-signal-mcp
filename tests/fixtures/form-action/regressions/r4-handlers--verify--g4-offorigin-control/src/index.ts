...
app.post('/account/settings', express.urlencoded({ extended: false }), requireLogin('https://idp.example.com/login'), validateBody(['tz'], '/account/settings?error=1'), (req: Request, res: Response) => {
